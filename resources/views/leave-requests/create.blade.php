    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3><i class="bi bi-calendar-plus"></i> New Leave Request</h3>
                <p class="text-subtitle text-muted">Submit your leave application</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/"><i class="bi bi-house-door"></i> Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('leave-requests.index') }}"><i class="bi bi-calendar-check"></i> Leave Requests</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><i class="bi bi-plus-circle"></i> New</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card shadow-lg">
            <div class="card-header bg-primary text-white">
                <h4 class="card-title text-white"><i class="bi bi-file-earmark-plus"></i> Create New Leave Request</h4>
            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="d-flex flex-column">
                                ...
                                <label for="employee_id" class="form-label">
                                    <i class="bi bi-person-badge"></i> Employee <span class="text-danger">*</span>
                                </label>
                                @error('employee_id')
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="d-flex flex-column">
                                ...
                                <label for="leave_type" class="form-label">
                                    <i class="bi bi-tag"></i> Leave Type <span class="text-danger">*</span>
                                </label>
                                @error('leave_type')
                                <div class="invalid-feedback">
                                    <i class="bi bi-exclamation-circle"></i> {{ $message }}
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="d-flex flex-column">
                                ...
                                <label for="start_date" class="form-label">
                                    <i class="bi bi-calendar-date"></i> Start Date <span class="text-danger">*</span>
                                </label>
                                @error('start_date')
                                <div class="invalid-feedback">
                                    <i class="bi bi-exclamation-circle"></i> {{ $message }}
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="d-flex flex-column">
                                ...
                                <label for="end_date" class="form-label">
                                    <i class="bi bi-calendar-date"></i> End Date <span class="text-danger">*</span>
                                </label>
                                @error('end_date')
                                <div class="invalid-feedback">
                                    <i class="bi bi-exclamation-circle"></i> {{ $message }}
                    ...
                    <div class="mb-4">
                        <div class="form-floating">
                            <textarea class="form-control @error('reason') is-invalid @enderror"
                                      id="reason" name="reason" style="height: 100px" required>{{ old('reason') }}</textarea>
                            <label for="reason">
                                <i class="bi bi-chat-left-text"></i> Reason <span class="text-danger">*</span>
                            </label>
                            @error('reason')
                            <div class="invalid-feedback">
                                <i class="bi bi-exclamation-circle"></i> {{ $message }}
