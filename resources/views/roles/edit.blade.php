    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3><i class="bi bi-shield-lock"></i> Edit Role</h3>
                <p class="text-subtitle text-muted">Update role information and permissions</p>
            </div>
        ...
        <div class="card shadow-lg">
            <div class="card-header bg-primary text-white py-3">
                <h4 class="card-title text-white mb-0">
                    <i class="bi bi-pencil-square me-2"></i>Edit Role Details
                </h4>
            </div>
                ...
                <form action="{{ route('roles.update', $role->id) }}" method="POST" class="form form-horizontal">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-10 mx-auto">
                            ...
                            <div class="mb-4">
                                <label for="title" class="form-label fw-bold">Role Title</label>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              ...
                                              placeholder="Enter role description" required>{{ old('description', $role->description) }}</textarea>
                                </div>
                                @error('description')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
