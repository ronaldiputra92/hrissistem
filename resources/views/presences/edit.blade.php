...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3><i class="bi bi-calendar-check"></i> Edit Attendance</h3>
                <p class="text-subtitle text-muted">Update employee attendance record</p>
            </div>
    ...
    <section class="section">
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                <form action="{{ route('presences.update', $presence->id) }}" method="POST" class="form form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="row mt-3">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control dateTime @error('check_in') is-invalid @enderror"
                                                   id="check_in" name="check_in" value="{{ old('check_in', $presence->check_in) }}"
                                                   placeholder="HH:MM">
                                        </div>
                                        @error('check_in')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control dateTime @error('check_out') is-invalid @enderror"
                                                   id="check_out" name="check_out" value="{{ old('check_out', $presence->check_out) }}"
                                                   placeholder="HH:MM">
                                        </div>
                                        @error('check_out')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control @error('date') is-invalid @enderror"
                                                   id="date" name="date" value="{{ old('date', $presence->date) }}" required>
                                        </div>
                                        @error('date')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
