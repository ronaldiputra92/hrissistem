    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3><i class="bi bi-calendar-plus"></i> New Presence</h3>
                <p class="text-subtitle text-muted">Record employee attendance</p>
            </div>
        ...
        <div class="card shadow-lg">
            <div class="card-header bg-primary text-white py-3">
                <h4 class="card-title text-white mb-0">
                    <i class="bi bi-person-lines-fill me-2"></i>Attendance Record
                </h4>
            </div>
                        ...
                        <div class="col-md-8 mx-auto">
                            ...
                            <div class="card shadow-sm mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        <div class="map-container rounded" style="height: 300px; overflow: hidden;">
                                            <iframe width="100%" height="100%" id="map" frameborder="0" style="border:0"></iframe>
                                        </div>
                                    </div>
            ...
            navigator.geolocation.getCurrentPosition(
                function(position) {
                    ...
                    if (distance <= threshold) {
                        ...
                        presentBtn.innerHTML = `<i class="bi bi-x-circle me-2"></i> Too Far (${distance.toFixed(2)} km)`;
                    }
                },
                function(error) {
                    console.error("Error getting location: ", error);
                    presentBtn.disabled = true;
                    presentBtn.innerHTML = '<i class="bi bi-exclamation-triangle me-2"></i> Location Required';
                }
            );
        } else {
            presentBtn.disabled = true;
