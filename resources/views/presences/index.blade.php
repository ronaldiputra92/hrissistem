        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3><i class="bi bi-calendar-check"></i> Kehadiran</h3>
                    <p class="text-subtitle text-muted">Kelola data kehadiran karyawan</p>
                </div>
                ...
                <div class="card-header bg-primary text-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title text-white mb-0">
                            <i class="bi bi-list-ul me-2"></i>Data Kehadiran
                        </h4>
                        <span class="badge bg-light text-primary fs-6">
                            Total: {{ $presences->count() }} Karyawan
                        </span>
                    </div>
                </div>
                                            ...
                                            <td class="text-end">
                                                <div class="btn-group gap-2" role="group">
                                                    ...
                                                    <form action="{{ route('presences.destroy', $presence->id) }}"
                                                        ...
                                                        onsubmit="return confirm('Delete this presence record?');">
                                                        @csrf
                                                        @method('DELETE')
