    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Handle Data Penggajian Karyawan</p>
            </div>
            ...
            <div class="card-body" id="print-area">
                <div class="print-header d-none d-print-block">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="mb-0">PAYROLL RECEIPT</h2>
                            <p class="text-muted mb-0">{{ date('d F Y') }}</p>
                        </div>
                        <div class="text-end">
                            <p class="text-muted mb-0">PT Indo Global Teknologi</p>
                        </div>
                    </div>
                    <hr class="my-3">
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control-plaintext border-bottom pb-2" id="employee" value="{{ $payroll->employee->full_name }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="salary" class="form-label fw-bold">Basic Salary</label>
                            <input type="text" class="form-control-plaintext border-bottom pb-2" id="salary" value="Rp.{{ number_format($payroll->salary, 0, ',', '.') }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="bonuses" class="form-label fw-bold">Bonuses</label>
                            <input type="text" class="form-control-plaintext border-bottom pb-2" id="bonuses" value="Rp.{{ number_format($payroll->bonuses, 0, ',', '.') }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="deductions" class="form-label fw-bold">Deductions</label>
                            <input type="text" class="form-control-plaintext border-bottom pb-2" id="deductions" value="Rp.{{ number_format($payroll->deductions, 0, ',', '.') }}" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="pay_date" class="form-label fw-bold">Pay Date</label>
                            <input type="text" class="form-control-plaintext border-bottom pb-2" id="pay_date" value="{{ $payroll->pay_date->format('d F Y') }}" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="print-footer mt-5 d-none d-print-block">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p class="mb-1"><strong>Employee Signature</strong></p>
