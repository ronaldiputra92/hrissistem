        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3><i class="bi bi-cash-stack"></i> Manajemen Penggajian</h3>
                    <p class="text-subtitle text-muted">Pencatatan dan pemrosesan penggajian secara komprehensif</p>
                </div>
                ...
                <div class="card-header bg-primary text-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title text-white mb-0">
                            <i class="bi bi-list-ul me-2"></i>Rekap Penggajian
                        </h4>
                        <span class="badge bg-light text-primary fs-6">
                            Total: {{ $payrolls->count() }} Karyawan
                        </span>
                    </div>
                </div>
                                ...
                                @foreach ($payrolls as $payroll)
                                    <tr>
                                        ...
                                        <td class="text-end text-danger">
                                            -Rp{{ number_format($payroll->deductions, 0, ',', '.') }}</td>
                                        <td class="text-end text-success">
                                            +Rp{{ number_format($payroll->bonuses, 0, ',', '.') }}</td>
                                        <td class="text-end fw-bold">
                                            Rp{{ number_format($payroll->net_salary, 0, ',', '.') }}</td>
