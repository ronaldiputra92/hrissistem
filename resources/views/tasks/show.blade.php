    ...
    <div class="page-title">
        <div class="row align-items-center">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Task Details</h3>
                <p class="text-subtitle text-muted">Detailed view of task information</p>
            </div>
                    ...
                    <div class="col-lg-12 mt-3">
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <h6 class="fw-bold mb-0 ms-2">Title</h6>
                            </div>
                            <div class="ps-5">
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <h6 class="fw-bold mb-0 ms-2">Assigned Employee</h6>
                            </div>
                            <div class="ps-5">
                                <p class="mb-0">
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <h6 class="fw-bold mb-0 ms-2">Due Date</h6>
                            </div>
                            <div class="ps-5">
                                <p class="mb-0">
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <h6 class="fw-bold mb-0 ms-2">Description</h6>
                            </div>
                            <div class="ps-5">
