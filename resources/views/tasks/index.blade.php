        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Kelola dan pantau tugas karyawan secara efisien</p>
                </div>
                ...
                <div class="card-header bg-primary text-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="card-title fw-bold mb-0 text-white">
                            <h4> <i class="bi bi-clipboard-plus fs-4 mb-2 me-2"></i> Rekap Tugas</h4>
                        </div>
                        <div class="card-title fw-bold mb-0 text-white">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="table1">
                            <thead class="table-light">
                                <tr>
                                    <th class="fw-semibold">Judul Tugas</th>
                                    <th class="fw-semibold">Ditugaskan Kepada</th>
                            ...
                            <tbody>
                                @forelse ($tasks as $task)
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-sm me-2">
                                                    <img src="https://ui-avatars.com/api/?name={{ $task->employee->full_name }}&background=random"
                                        ...
                                        <td>
                                            <span
                                                class="text-nowrap {{ $task->due_date < now() && $task->status != 'done' ? 'text-danger' : '' }}">
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span
                                                    class="badge rounded-pill bg-secondary-soft text-secondary text-capitalize">
                                                    {{ $task->status }}
                                                </span>
                                            @endif
                                        </td>
                                                ...
                                                @if (session('role') == 'HR')
                                                    @if ($task->status == 'pending')
                                                        <a href="{{ route('tasks.done', $task->id) }}"
                                                            class="btn btn-sm btn-outline-success" title="Mark as Done">
                                                            <i class="bi bi-check-lg"></i>
                                                        </a>
                                                        <a href="{{ route('tasks.rejected', $task->id) }}"
                                                            class="btn btn-sm btn-outline-danger" title="Reject">
                                                            <i class="bi bi-x-lg"></i>
                                                        </a>
                                                    @elseif ($task->status == 'done')
                                                        <a href="{{ route('tasks.pending', $task->id) }}"
                                                            class="btn btn-sm btn-outline-warning" title="Pending">
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center py-4">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <p class="text-muted mt-2 mb-0">Tugas Tidak Ditemukan</p>
                                                @if (session('role') == 'HR')
                                                    <a href="{{ route('tasks.create') }}"
                                                        class="btn btn-sm btn-primary mt-3 rounded-pill">
