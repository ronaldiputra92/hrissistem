    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3><i class="bi bi-building-add"></i> New Department</h3>
                <p class="text-subtitle text-muted">Create a new department for your organization</p>
            </div>
        ...
        <div class="card shadow-lg">
            <div class="card-header bg-primary text-white py-3">
                <h4 class="card-title text-white mb-0">
                    <i class="bi bi-file-earmark-plus"></i> Department Information
                </h4>
            </div>
                        ...
                        <div class="col-md-10 mx-auto">
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-4">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-save me-1"></i> Create Department
                                </button>
                            </div>
                        </div>
                    </div>
