        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3><i class="bi bi-person-plus-fill"></i> Tambah Karyawan Baru</h3>
                    <p class="text-subtitle text-muted">Lengkapi formulir untuk mendaftarkan karyawan baru</p>
                </div>
            ...
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white py-3">
                    <h4 class="card-title text-white mb-0">
                        <i class="bi bi-person-lines-fill me-2"></i>Informasi Karyawan
                    </h4>
                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('full_name') is-invalid @enderror"
                                            id="full_name" name="full_name" placeholder="Masukan Nama Lengkap" required>
                                        @error('full_name')
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="phone_number" name="phone_number" placeholder="Masukan Nomor Handphone"
                                            required>
                                        @error('phone_number')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('salary') is-invalid @enderror"
                                            id="salary" name="salary" placeholder="Masukan Jumlah Gaji" required>
                                        @error('salary')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
