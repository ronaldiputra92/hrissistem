        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3><i class="bi bi-person-gear"></i> Edit Karyawan</h3>
                    <p class="text-subtitle text-muted">Edit Informasi Karyawan</p>
                </div>
            ...
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white py-3">
                    <h4 class="card-title text-white mb-0">
                        <i class="bi bi-person-lines-fill me-2"></i>Edit Informasi Karyawan
                    </h4>
                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date"
                                            ...
                                            name="hire_date" value="{{ old('hire_date', $employee->hire_date) }}"
                                            required>
                                    </div>
                                    @error('hire_date')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
