        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3><i class="bi bi-person-lines-fill"></i> Detail Informasi Karyawan</h3>
                    <p class="text-subtitle text-muted">Informasi karyawan secara menyeluruh</p>
                </div>
                ...
                <div class="card-body">
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control bg-light" value="{{ $employee->full_name }}"
                                        readonly>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control bg-light" value="{{ $employee->email }}"
                                        readonly>
                                </div>
                            </div>

                            <div class="mb-4">
                                <label class="form-label fw-bold text-primary">Nomor Handphone</label>
                                <div class="input-group">
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold text-primary">Alamat</label>
                                <div class="input-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold text-primary">Tanggal Bergabung</label>
                                <div class="input-group">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><i
                                            class="bi bi-person-workspace mb-2"></i></span>
                                    <input type="text" class="form-control bg-light" value="{{ $employee->role->title }}"
                                        readonly>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text bg-light">
                                        <i
                                            class="bi {{ $employee->status == 'active' ? 'bi-check-circle' : 'bi-x-circle' }} mb-2"></i>
                                    </span>
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold text-primary">Gaji</label>
                                <div class="input-group">
                    ...
                    <div class="d-flex justify-content-between mt-5">
                        <a href="{{ route('employees.index') }}" class="btn btn-secondary">
                            <i class="bi bi-arrow-left-circle me-2"></i>Kembali ke List
                        </a>
                    </div>
                </div>
            </div>
